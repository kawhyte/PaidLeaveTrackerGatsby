...
let statusColor = {
    ...
    "filing" : {
        ...
        color:"bg-yellow"},
    "introduction" : { name:"introduced, typically the first action", color:"bg-yellow"},
    "reading-1" : { name: "first reading (often same as introduction)", color:"bg-yellow"},
    "reading-2" : {name: "second reading" ,  color:"bg-yellow"},
    "reading-3" : {name:"third reading (often same as passage)" ,  color:"bg-yellow"},
    "passage" : {name:"bill is passed by the chamber" ,  color:"bg-yellow"},
    "failure" : {name:"bill fails to proceed from the chamber" ,  color:"bg-light-red"},
    "withdrawal" : { name:"bill is withdrawn", color: "bg-light-pink"},
    "substitution" : {name:"a substitution is made to the bill text", color: "bg-yellow"},
    "deferral" : {name:"consideration of the bill was deferred", color: "bg-yellow"},
    "receipt" : {name:"a bill was received by another chamber", color: "bg-yellow"},
    "referral" : {name:"a bill was sent somewhere for consideration", color: "bg-light-pink"},
    "referral-committee" : {name:"a bill was sent to a committee for consideration", color: "bg-light-pink"},
    "became-law" : {name:"the bill became law (through signature or inaction)", color: "bg-light-green"},
    "amendment-introduction" : {name:"an amendment is introduced", color: "bg-yellow"},
    "amendment-passage" : {name:"an amendment passes", color: "bg-yellow"},
    "amendment-withdrawal" : {name:"an amendment is withdrawn", color: "bg-yellow"},
    "amendment-failure" : {name:"an amendment fails to pass", color: "bg-light-pink"},
    "amendment-amendment" : {name:"an amendment is amended", color: "bg-yellow"},
    "amendment-deferral" : {name:"consideration of an amendment is deferred", color: "bg-yellow"},
    "committee-passage" : {name:"the bill passes the current committee (unknown outcome, typically favorble)", color: "bg-yellow"},
    "committee-passage-favorable" : {name:"the bill passes the current committee favorably", color: "bg-yellow"},
    "committee-passage-unfavorable" : {name:"the bill passes the current committee with an unfavorable report", color: "bg-light-pink"},
    "committee-failure" : {name:"the bill fails to advance out of committee", color: "bg-light-pink"},
    "executive-receipt" : {name:"the bill is sent to the governor", color: "bg-light-green"},
    "executive-signature" : {name:"the governor signs the bill", color: "bg-light-green"},
    "executive-veto" : {name:"the governor vetos the bill", color: "bg-light-red"},
    "executive-veto-line-item" : {name:"the governor uses a line-item veto to strike part of a bill", color: "bg-light-green"},
    "veto-override-passage" : {name:"a veto override vote occurred and succeeded", color: "bg-light-green"},
    "veto-override-failure" : {name:"a veto override vote occurred and failed", color: "bg-light-red"},
    null: {
