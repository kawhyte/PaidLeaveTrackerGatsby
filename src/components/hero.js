...
<div className="relative bg-white overflow-hidden">
  ...
  <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://res.cloudinary.com/babyhulk/image/upload/f_auto/v1588631591/hero-image/family-green.svg" alt="" />
  </div>
</div>
