...
<div className=" p-2 w-full lg:flex justify-center">
  <div className="max-w-md shadow-xl mx-1 my-1 border-r border-b border-l border-gray-400  border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    <div className="mb-8">
      ...
      <div className="p-2 items-center text-indigo-700 bg-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
...
<div className="flex">       
        ...
        <p className="text-gray-700 leading-none mr-2 mb-3 leading-snug">Last activity posted on <time>{format(new Date(lastAction[0].date),'LLL dd, yyyy')}</time> - <span className="text-gray-700 mb-3  f6 db pv2 "> {sentenceCase(actions[0].description)}</span></p>
</div>
