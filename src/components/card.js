...
<div className="flex">       
        ...
        <p className="text-gray-700  mr-2 mb-3 leading-snug">Last activity posted on <time>{format(new Date(lastAction[0].date),'LLL dd, yyyy')}</time> - <span className="text-gray-700 mb-3  f6 db pv2 "> {sentenceCase(actions[0].description)}</span></p>
</div>
